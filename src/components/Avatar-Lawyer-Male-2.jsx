...
Command: npx gltfjsx@6.5.3 public\models\6836d82f0969d65e4b3b8b33.glb -o src/components/Avatar2.jsx -r public 
*/
...
export function Avatar(props) {
  ...
  const { scene } = useGLTF('/models/6836d82f0969d65e4b3b8b33.glb');
  const clone = useMemo(() => SkeletonUtils.clone(scene), [scene]);
  const { nodes, materials } = useGraph(clone);
  
  const { animations: idleAnimation } = useFBX('animations/Debate.fbx');
...
useGLTF.preload('/models/6836d82f0969d65e4b3b8b33.glb')
